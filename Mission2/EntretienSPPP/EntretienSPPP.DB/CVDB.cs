...
namespace EntretienSPPP.DB
{
    public static class CVDB
    {
        ...
        public static List<CV> List()
        {
            ...
            //Commande
            String requete = @"SELECT Identifiant, DateDeb, DateFin, Entreprise, IdentifiantPersonne 
                               FROM CV";
            connection.Open();
        ...
        public static CV Get(Int32 identifiant)
        {
            ...
            SqlConnection connection = new SqlConnection(connectionStringSettings.ToString());
            //Commande
            String requete = @"SELECT Identifiant, DateDeb, DateFin, Entreprise, Secteur, Poste, IdentifiantPersonne 
                                FROM CV
